...
extension TextViewController {
    ...
    override public func loadView() {
        ...
        // NOTE: If the file is new we won't be showing diff changes
        // so if the file is new we disable version control for that said
        // file on their basis and not in general. Reason we do it on a per
        // file basis is because multiple editors can be open once and each
        // file git history might differ.
        if isVersionControlEnabled {
            gutterView.parseDiffRanges(diffStrings: ["@@ -5,0 +5,1 @@",
                                                     "@@ -10,2 +10,2 @@",
                                                     "@@ -15,1 +15,0 @@",
                                                     "@@ -23,0 +23,2 @@",
                                                     "@@ -30,5 +30,0 @@",
