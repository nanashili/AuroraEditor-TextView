...
public class TextViewController: NSViewController {
    ...
    public var isVersionControlEnabled: Bool
    ...
    internal var textFilters: [Filter] = []
    ...
    init(
        ...
        self.isVersionControlEnabled = isVersionControlEnabled
    ...
    func reloadUI() {
        ...
        ? NSColor.quaternaryLabelColor : NSColor.selectedTextBackgroundColor.withSystemEffect(.disabled).withAlphaComponent(0.15)
        ...
        : NSColor.selectedTextBackgroundColor.withSystemEffect(.disabled).withAlphaComponent(0.15)
