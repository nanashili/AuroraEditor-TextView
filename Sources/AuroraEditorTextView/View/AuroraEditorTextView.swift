...
public struct AuroraEditorTextView: NSViewControllerRepresentable {
    ...
    public init(
        ...
        isVersionControlEnabled: Bool = false,
    ...
    private var isVersionControlEnabled: Bool
    ...
    public func makeNSViewController(context: Context) -> TextViewController {
        let controller = TextViewController(
            ...
            isVersionControlEnabled: isVersionControlEnabled,
    ...
    public class Coordinator: NSObject {
        var parent: AuroraEditorTextView
